...
export const purchaseOrderService = {
  async getAllPurchaseOrders(organizationId: string): Promise<PurchaseOrder[]> {
    ...
    return data?.map(po => ({
      ...
      division: po.division && typeof po.division === 'object' && po.division !== null && po.division.name ? po.division : undefined,
      supplier: po.supplier && typeof po.supplier === 'object' && po.supplier !== null && po.supplier.name ? po.supplier : undefined
    })) || [];
  },
  ...
  async getPurchaseOrderById(id: string): Promise<PurchaseOrder | null> {
    ...
    return {
      ...
      division: data.division && typeof data.division === 'object' && data.division !== null && data.division.name ? data.division : undefined,
      supplier: data.supplier && typeof data.supplier === 'object' && data.supplier !== null && data.supplier.name ? data.supplier : undefined,
