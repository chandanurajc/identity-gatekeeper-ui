...
export const purchaseOrderService = {
  async getAllPurchaseOrders(organizationId: string): Promise<PurchaseOrder[]> {
    ...
    return data?.map(po => ({
      ...
      division: po.division && typeof po.division === 'object' && po.division !== null && 'name' in po.division ? po.division : undefined,
      supplier: po.supplier && typeof po.supplier === 'object' && po.supplier !== null && 'name' in po.supplier ? po.supplier : undefined
    })) || [];
  },
  ...
  async getPurchaseOrderById(id: string): Promise<PurchaseOrder | null> {
    ...
    return {
      ...
      division: data.division && typeof data.division === 'object' && data.division !== null && 'name' in data.division ? data.division : undefined,
      supplier: data.supplier && typeof data.supplier === 'object' && data.supplier !== null && 'name' in data.supplier ? data.supplier : undefined,
